...
public class Main {
	...
	public static HashMap<Integer, User> createPatients() {

		Patient patient = new Patient(10, "Yulia", "Melnyk", null, Vaccine.NONE, null, Type.PATIENT);
		Patient patient2 = new Patient(11, "Mariana", "Foster", null, Vaccine.NONE, null, Type.PATIENT);
		Patient patient3 = new Patient(12, "Alex", "Smith", null, Vaccine.NONE, null, Type.PATIENT);
		Patient patient4 = new Patient(13, "Sergio", "Gonzales", null, Vaccine.NONE, null, Type.PATIENT);
		Patient patient5 = new Patient(14, "Miriam", "Lopez", null, Vaccine.NONE, null, Type.PATIENT);
	...
	public static HashMap<Integer, User> createNurses() {
	...
	public static HashMap<Integer, User> createTechnicals() {
